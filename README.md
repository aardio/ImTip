...
> <a href="https://imtip.aardio.com/update/ImTip.7z">点这里下载 ImTip</a> - 仅 906 KB  
...
默认已配置以下热键：
- <kbd>Ctrl+#</kbd> 极速版：全局翻译 + 查单词（**闪电搜索**海量数据，自动还原词形、自动分解合成词）
- <kbd>Ctrl+@</kbd> AI 增强版：全局翻译 + 查单词（**AI 精讲**词根起源、文化习俗、用法要点、避坑指南）
...
[» 启用 AI 全局翻译](https://imtip.aardio.com/#help-dict)
...
[ImTip 支持可视化编辑状态提示外观](https://www.aardio.com/zh-cn/doc/?q=library-guide/std/key/ime.stateBar.html)
